...
Matrix4::Matrix4(const Matrix3& m3) {
	array[0][0] = m3.array[0];
	array[0][1] = m3.array[1];
	array[0][2] = m3.array[2];

	array[1][0] = m3.array[4];
	array[1][1] = m3.array[5];
	array[1][2] = m3.array[6];

	array[2][0] = m3.array[7];
	array[2][1] = m3.array[8];
	array[2][2] = m3.array[9];
